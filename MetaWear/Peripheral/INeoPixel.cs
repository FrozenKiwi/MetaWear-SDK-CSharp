...
namespace MbientLab.MetaWear.Peripheral {
    namespace NeoPixel {
        ...
        public interface IStrand {
            ...
            Task Clear(byte start, byte end);
            /// <summary>
            ...
            Task SetRgb(byte index, byte red, byte green, byte blue);
            /// <summary>
            ...
            Task Rotate(RotationDirection direction, ushort period, byte repetitions = 0xff);
            /// <summary>
    ...
    public interface INeoPixel : IModule {
        ...
        Task<IStrand> InitializeStrand(byte id, ColorOrdering ordering, StrandSpeed speed, byte gpioPin, byte nLeds);
        /// <summary>
